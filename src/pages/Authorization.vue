<template>
  <div class="hello">
        ...
        <div class="d-auth">
          <button type="button" class="btn btn-auth" @click="SignIn()">Login</button>
        </div>
  </form>
  </div>
</template>
